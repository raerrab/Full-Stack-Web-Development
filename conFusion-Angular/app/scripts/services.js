...
.factory('cartFactory', ['$rootScope', function ($rootScope) {
     
       var cartFac = {}; 
        
        cartFac.pushtocart = function(dish) {  
            //console.log('Push to cart', dish._id);
...
.factory('submitOrderFactory', ['$resource', 'baseURL', function ($resource, baseURL) {
